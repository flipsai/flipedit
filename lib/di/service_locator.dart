...
di.registerLazySingleton<MdkPlayerService>(() => MdkPlayerService(), dispose: (service) => service.dispose());
  di.registerLazySingleton<FfmpegCompositeService>(() => FfmpegCompositeService());
