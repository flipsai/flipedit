...
class ProjectAssets extends Table {
  ...
  TextColumn get sourcePath =>
      text()(); // Path to the asset file (column is named 'source_path' in the DB)
  TextColumn get type => text()(); // video, audio, image, etc.
  TextColumn get mimeType =>
      text().nullable()(); // For web/preview compatibility

  // Asset metadata
  IntColumn get durationMs =>
      integer().nullable()(); // For time-based assets like video/audio
