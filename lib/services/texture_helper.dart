...
class FixedTextureHelper {
  ...
  static Future<void> _initializeTexture(_ActiveTexture texture, int width, int height) async {
    ...
    if (!result) {
      logError(_logTag, 'Failed to initialize texture data for ID: ${texture.textureId}');
    } else {
      logInfo(_logTag, 'Successfully initialized texture ${texture.textureId} with loading indicator');
    }
  }
...
class TextureHelper {
  ...
  static Future<(int textureId, int texturePtr)> createAndGetTexturePointer(
    ...
    logInfo(_logTag, 'WARNING: Using deprecated createAndGetTexturePointer. Use FixedTextureHelper.createTexture instead.');
    ...
    logInfo(_logTag, 'Created texture $textureId (pointer approach deprecated)');
    return (textureId, 0);
  }
  ...
  static Future<void> updateTextureData(
    ...
    logInfo(_logTag, 'WARNING: Using deprecated TextureHelper.updateTextureData. Use FixedTextureHelper.updateTextureData instead.');
