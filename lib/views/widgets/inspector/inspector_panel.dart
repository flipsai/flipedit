...
import 'package:flutter_box_transform/flutter_box_transform.dart' show Flip; // Import for Flip enum
...
class InspectorPanel extends StatelessWidget with WatchItMixin {
  ...
  Widget _buildPreviewTransform(BuildContext context, ClipModel clip) {
    ...
    final previewRect = clip.previewRect ?? const Rect.fromLTWH(100, 100, 320, 180);
    final previewFlip = clip.previewFlip;

    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Preview Transform', style: FluentTheme.of(context).typography.bodyStrong),
        const SizedBox(height: 8),
            ...
            Expanded(
              child: InfoLabel(
                ...
                child: NumberBox<double>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                        value, previewRect.top, previewRect.width, previewRect.height
                      ));
                    }
                  },
                ),
              ...
              child: InfoLabel(
                ...
                child: NumberBox<double>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                        previewRect.left, value, previewRect.width, previewRect.height
                      ));
                    }
                  },
                ),
              ...
              child: InfoLabel(
                ...
                child: NumberBox<double>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                        previewRect.left, previewRect.top, value, previewRect.height
                      ));
                    }
                  },
                ),
              ...
              child: InfoLabel(
                ...
                child: NumberBox<double>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                        previewRect.left, previewRect.top, previewRect.width, value
                      ));
                    }
                  },
                ),
        ...
        Row(
          ...
          children: [
            Button(
              onPressed: () {
                timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                  previewRect.left, previewRect.top, 320, 180 // 16:9
                ));
              },
            ...
            Button(
              onPressed: () {
                timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                  previewRect.left, previewRect.top, 240, 240 // 1:1
                ));
              },
            ...
            Button(
              onPressed: () {
                timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                  previewRect.left, previewRect.top, 270, 360 // 3:4
                ));
              },
            ...
            Button(
              onPressed: () {
                timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
                  previewRect.left, previewRect.top, 360, 270 // 4:3
                ));
              },
        ...
        InfoLabel(
          ...
          child: ComboBox<Flip>(
            ...
            items: [
              ...
              ComboBoxItem<Flip>(value: Flip.horizontal, child: const Text('Horizontal')),
              ComboBoxItem<Flip>(value: Flip.vertical, child: const Text('Vertical')),
            ],
            onChanged: (value) {
              if (value != null) {
                timelineViewModel.updateClipPreviewFlip(clip.databaseId!, value);
              }
            },
          ),
        ),
        ...
        Button(
          onPressed: () {
            ...
            timelineViewModel.updateClipPreviewRect(clip.databaseId!, Rect.fromLTWH(
              left, top, previewRect.width, previewRect.height
            ));
          },
