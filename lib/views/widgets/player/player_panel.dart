...
class _PlayerPanelState extends State<PlayerPanel> {
  late final NativePlayerViewModel _playerViewModel;
  late final TimelineNavigationViewModel _timelineNavViewModel;
  
  @override
  void initState() {
    super.initState();
    _playerViewModel = NativePlayerViewModel();
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                ComboBox<int>(
                  value: _playerViewModel.renderMethod,
                  items: const [
                    ComboBoxItem(
                      value: 0,
                    ...
                    ComboBoxItem(
                      value: 1,
                      child: Text('Native FFI'),
                    ),
                    ComboBoxItem(
                      value: 2,
                      child: Text('OpenCV Direct'),
                    ),
                  ],
                  onChanged: (value) {
                    if (value != null) {
                      _playerViewModel.setRenderMethod(value);
                    }
                  },
                ),
