...
class PythonPlayerPanel extends StatelessWidget with WatchItMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final textureId = watchValue(
      (OpenCvPythonPlayerViewModel vm) => vm.textureIdNotifier,
    );
    final isReady = watchValue(
      (OpenCvPythonPlayerViewModel vm) => vm.isReadyNotifier,
    );
    final status = watchValue(
      (OpenCvPythonPlayerViewModel vm) => vm.statusNotifier,
    );
